export default function Hero() {
  return (
    <section
      className="max-h-max bg-cover pt-32 lg:pt-8  bg-[url('/hero.jpg')]  md:bg-[url('/background.jpg')]  bg-center bg-no-repeat text-white "
    >
      <div className="max-w-7xl mx-auto  pl-6 relative">
        <article className="grid grid-cols-1  lg:grid-cols-2 gap-5 lg:pt-60  ">
          <div className="">
            ...
            <button className="bg-gradient-to-r from-[#851d86] to-[#0048fe] px-24 py-4 rounded-md mt-12 ">
