  ...
  return (
    <section id="beneficio" className="mt-[100px]">
      <article className="">
        ...
        <p className="text-center text-[17px] m-auto max-w-96 text-zinc-300 md:text-[1.7rem] md:max-w-4xl md:mt-10">
          Conheça os benefícios incríveis que o Union proporciona para seus
          membros!
        </p>
        <div className="mt-[50px] max-w-7xl  mx-auto md:mt-[100px]">
          <div className="flex flex-col justify-center items-center md:flex-row md:gap-14 md:justify-start ">
            <div className="">
              <img
                className="w-[90px] md:w-[170px]"
                src="./rocket-2.svg"
                alt="rocket-img"
              />
            </div>
          ...
          <div className="flex flex-col justify-center items-center md:flex-row md:gap-14 md:justify-start mt-20 ">
            <div className="">
              <img
                className="w-[90px] md:w-[170px]"
